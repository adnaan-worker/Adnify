...
import { getLLMConfigForTask, getProviderModelContext } from '../services/llmConfigService'
import type { TaskPlan, OrchestratorTask, ExecutionStats } from './types'
...
import { shouldEscalatePatrolState, shouldTripCircuitBreaker } from '../services/circuitBreakerService'
import { buildExecutionTaskInputFromPlan } from '../services/taskTemplateService'
import { cleanupTaskExecutionWorkspace, prepareTaskExecutionWorkspace } from '../services/executionWorkspaceService'
import { restoreExecutionTaskFromRecovery, syncTaskRecoveryCheckpoint } from '../services/executionRecoveryService'
import { buildWorkPackageHandoff } from '../services/handoffBrokerService'
import { createOwnershipRegistrySnapshot, acquireOwnership, releaseOwnership } from '../services/ownershipRegistryService'
import { buildChangeProposal } from '../services/proposalEngineService'
import { applyChangeProposal, captureBaselineForScopes } from '../services/proposalApplyService'
import { resolveSpecialistRoute } from '../services/modelRoutingService'
import { buildBrowserVerificationPrompt, getBrowserVerificationCapability } from '../services/browserVerificationService'
import { DEFAULT_PATROL_THRESHOLDS, evaluateExecutionPatrol, type PatrolThresholds } from '../services/patrolService'
import {
...
} from '../services/executionHeartbeatService'
...
function waitForAgentCompletion(
    ...
    timeoutMs = useStore.getState().agentConfig.toolTimeoutMs,
...
async function executeTask(
    ...
    try {
        ...
        EventBus.emit({ type: 'task:failed', taskId: task.id, error: failureReason })
